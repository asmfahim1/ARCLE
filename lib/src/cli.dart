...
class Cli {
  ...
  String _usage(ArgParser parser) {
    return [
      ...
      '    1) \ud83e\uddf1 BLoC      Event-driven, highly testable',
      '    2) \u26a1 GetX      Lightweight, zero configuration',
      '    3) \ud83c\udf0a Riverpod  Type-safe, no context needed',
      '',
      '  GLOBAL OPTIONS',
      parser.usage,
      '',
      '  EXAMPLES',
      '    arcle create my_app --state 1        # Create with BLoC',
      '    arcle feature payments --state bloc  # Add payments feature',
      '    arcle build --mode release           # Build release APK',
      '',
      '  \ud83d\udca1 TIP: Use --state 1|2|3 to skip interactive prompts in CI/CD',
      '',
    ].join('\n');
  }
}
