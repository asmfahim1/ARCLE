...
import 'package:bloc_app/core/common_widgets/common_button.dart';
import 'package:bloc_app/core/common_widgets/common_text_field.dart';
import 'package:bloc_app/core/di/injection.dart';
import 'package:bloc_app/core/utils/result.dart';
import 'package:bloc_app/features/demo/domain/entities/user_entity.dart';
...
import 'package:bloc_app/features/demo/presentation/pages/login_screen.dart';
...
void main() {
  testWidgets('Login screen renders', (tester) async {
    ...
    await tester.pumpWidget(
      MaterialApp(home: const LoginScreen(), locale: const Locale('en')),
    );
